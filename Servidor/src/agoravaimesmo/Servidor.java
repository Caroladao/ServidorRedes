    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            if (socket.isConnected()) {
                ...
                //cria um BufferedReader a partir do InputStream do cliente porque o Scanner mesmo após ter 
                //terminado de ler a requisição ele espera que a a conexão seja encerrada
